...
#'
#' @param input_data_met A dataframe or matrix containing the gene methylation profiling data in which each row is a gene and each column is a tumor sample [Methylation (HM450) beta-values].
#' @export
